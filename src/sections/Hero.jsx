...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col justify-center items-center border bg-bg-secondary rounded-4xl mb-2 max-sm:px-1 max-md:px-2">
      <div className="w-full xl:w-7xl mx-auto">
        {/* Main Content */}
        <div className="z-10">
          <div>
            {/* Software Engineer */}
