...
import photoBentoOne from "../assets/images/photo-bento-01.webp";
import photoBentoTwo from "../assets/images/photo-bento-02.webp";
...
import photoBentoTen from "../assets/images/photo-bento-10.webp";
import photoBentoEleven from "../assets/images/photo-bento-11.webp";
import photoBentoTwelve from "../assets/images/photo-bento-12.jpg";
...
export const techStack2 = [
  ...
  { iconName: "Figma", icon: figma },
  { iconName: "Notion", icon: notion },
  { iconName: "ChatGPT", icon: chatGPT },
  { iconName: "Claude", icon: claude },
  { iconName: "Spotify", icon: spotify },
];
