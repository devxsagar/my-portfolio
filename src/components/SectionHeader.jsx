...
const SectionHeader = ({ heading, subheading="" }) => {
  return (
    <header className="text-center mb-8 md:mb-10 lg:mb-16">
      <h2
        className="w-fit mx-auto font-medium uppercase text-xs md:text-sm lg:text-sm text-text-secondary
      ...
      <div >
        <p className="max-sm:max-w-[70vw] mx-auto text-2xl md:text-[2.5rem] font-bold mt-2 break-after-avoid whitespace-normal text-center">
