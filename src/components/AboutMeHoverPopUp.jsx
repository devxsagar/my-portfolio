...
const AboutMeHoverPopUp = () => {
  ...
  return (
    <button onClick={() => navigate("/about-me")}>
      <motion.div
        className="w-fit text-center text-sm lg:text-lg text-[#ffffff] bg-blue px-3 py-2 rounded-3xl hidden group-hover:flex items-center gap-2 font-semibold tracking-wide
